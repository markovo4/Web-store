...
const Logo = ({width = '116', height = '27'}) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 116 27">
            <defs>
                <path
                    d="M14.133 0l88.355.006a13.51 13.51 0 0 1 8.462 2.96c3.124 2.48 5.073 6.405 5.048 10.407.067 3.297-1.18 6.59-3.373 9.047-2.514 2.885-6.302 4.554-10.12 4.57l-85.6.003c-2.405-.017-4.866.16-7.2-.563-4.37-1.246-7.974-4.852-9.19-9.236-.94-3.16-.596-6.633.84-9.593C3.207 3.75 6.987.906 11.2.2c.967-.164 1.954-.2 2.932-.2z"
                    id="A"
                />
            </defs>
